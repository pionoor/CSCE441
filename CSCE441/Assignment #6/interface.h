...
extern void select_callback(Fl_Button*, void*);
extern Fl_Button *select_button;

extern void loadOriginal_callback(Fl_Button*, void*);
extern Fl_Button *loadOriginal_button;
